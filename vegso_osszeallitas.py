...
def add_widgets_to_window(window,canvas,center,height,start_button):
    ...
    def add_cords(event):
        if "coordinate" in text_road.get():
    ...
    text_box.insert(0, "Enter speed in km/h")
    #Mass_enter
    ...
    text_box2.insert(0, "  Enter weight in kg")
    #Cords_enter
    ...
    text_road.insert(0, " Enter one coordinate")
    ...
    display_rules = customtkinter.CTkLabel(
        ...
        width=290, 
        height=50, 
        text="Enter 4 x and 4 y coordinates alternately",
        text_color="#57b066",
        corner_radius=20,
        bg_color="#aceca2",   
    ...
    display_rules.place(x=center-200, y=30)
...
class PathFollower:
    ...
    def calculate_acceleration(self, theta_deg):
        ...
        acceleration = g * math.sin(theta_rad) """
